...
const TermsAndConditions = () => {
    return (
        <div className="container">
            ...
            <div className="desc">Terms of Service for Antern</div>
            <div className="content">
                <div className="opening">
                    ...
                    <p>
                        ...
                        terms and conditions. Do not continue to use Antern if
                ...
                <div className="sections">
                    ...
                    <div className="section">
                        ...
                        <div className="section-content">
                            ...
                            <p>
                                You hereby grant Antern a non-exclusive license
                    ...
                    <div className="section">
                        ...
                        <div className="section-content">
                            ...
                            <p>
                                ...
                                absence of Antern; and (d) the link is in the
                            ...
                            <p>
                                ...
                                e-mail to Antern. Please include your name, your
                    ...
                    <div className="section">
                        <div className="section-heading">iFrames</div>
                        <div className="section-content">
                    ...
                    <div className="section">
                        <div className="section-heading">Content Liability</div>
                        <div className="section-content">
                            ...
                            Website that may be interpreted as libelous, obscene
                            or criminal, or which infringes, otherwise violates,
                            or advocates the infringement or other violation of,
                            any third party rights.
                        </div>
                    </div>
                    <div className="section">
                        <div className="section-heading">Your Privacy</div>
                        <div className="section-content">
